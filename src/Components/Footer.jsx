    ...
    <div className="container border-top footer-container">
      <footer className="py-3 my-4">
        <ul className="nav justify-content-center border-bottom pb-3 mb-3">
          ...
          <li className="nav-item">
            <Link to="https://github.com/Johnvilin-Sibina" target="_blank" className="nav-link px-2 text-body-secondary">
            <IoLogoGithub color="rgb(84, 13, 239)" size="25" title="GitHub"/>
            </Link>
          </li>
          
          <li className="nav-item">
            <Link to="https://linkedin.com/in/johnvilin-sibina-j-5ba45425a" target="_blank" className="nav-link px-2 text-body-secondary">
